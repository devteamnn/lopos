...
const searchBarcodeForm = document.querySelector('#operations-sale-search-barcode-form');
const searchBarcodeFormBarcode = document.querySelector('#operations-sale-search-barcode');

const tradeForm = document.querySelector('#operations-sale-form');
const tradeFormStock = document.querySelector('#operations-sale-stocks-list');
const tradeFormSubmit = document.querySelector('#operations-sale-submit');
const tradeFormKontragents = document.querySelector('#operations-sale-kontragents-list');
const tradeFormDelivery = document.querySelector('#operations-sale-delivery');

const leftColumn = document.querySelector('#operations-sale-left');
const submitSpinner = document.querySelector('#operation-sale-submit-spinner');

const searchForm = document.querySelector('#operations-sale-search');
const modalAdd = document.querySelector('#operations-sale-add');
const modalAddCount = document.querySelector('#operations-sale-add-input');
const modalDiscount = document.querySelector('#operations-sale-discount');
const modalDiscountCount = document.querySelector('#operations-sale-discount-input');
...
const clickGroupsCallback = () => {
  leftColumn.innerHTML = markupTools.getLoadSpinner('sp-2', 'Загрузка');
  operationsTradeServer.getGoodsFromServer(stor.currentGroupId, tradeFormStock.value, getGoodsCallback);
};
...
const addHandlers = () => {
  ...
  document.querySelector('#operations-sale-discountBtn').addEventListener('click', () => {
    operationsTradeDiscount.show(discountCallback, dataStore.discount_max);
  });

  document.querySelector('#operations-sale-clear-but').addEventListener('click', () => {
    operationsTradeLeft.drawGroups(dataStore.all_groups, clickGroupsCallback, clichButtonBackCallback);
    operationsTradeRight.clear();
  });
